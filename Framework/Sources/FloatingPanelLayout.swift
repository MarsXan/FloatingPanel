...
public protocol FloatingPanelLayout: class {
    ...
    ///
    /// Its returning value has a different meaning for each positiion.
    /// For full position, it indicates a top inset from a safe area. For half and tip
    /// positions, it indicates a bottom inset from a safe area.
    /// For hidden position, it indicates a bottom inset from the bottom of a surface view.
